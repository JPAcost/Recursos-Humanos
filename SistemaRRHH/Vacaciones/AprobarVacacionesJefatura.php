...
if (!can('Vacaciones_aprobados') && !isJefatura() && !isAdmin()) {
...
if (!$resultado) {
    die("Error al consultar vacaciones pendientes de jefatura: " . $conexion->error);
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <title>Aprobar Vacaciones - Jefatura</title>
...
<div class="main-content">
    <h1>Aprobación de Vacaciones - Jefatura</h1>
    <p style="margin-top:-15px;color:#666;">
        Aquí se muestran las solicitudes pendientes de revisión por jefatura.
    </p>
    ...
    <div class="table-box">
        <table>
            ...
            <tbody>
                <?php if ($resultado && $resultado->num_rows > 0): ?>
                    <?php while ($r = $resultado->fetch_assoc()): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="AccionVacacionesJefatura.php" method="POST" style="display:flex;flex-direction:column;gap:8px;min-width:220px;">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" style="text-align:center;">No hay solicitudes pendientes de aprobación por jefatura.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
